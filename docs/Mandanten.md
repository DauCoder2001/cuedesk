...
- **Verein bearbeiten** (ergänzt 26.09.2026, Migration stufe14_verein_aendern): Name, Kurzname, Adresse und Test-Kennzeichen; im Protokoll mit vorher → nachher. Logo und Vorgaben bleiben beim Vereins-Administrator. Dazu Spiellokal (Straße, PLZ, Ort), Homepage und Kontakt-E-Mail (Migration stufe14_verein_anschrift); die pflegt auch der Vereins-Administrator auf der Seite System. Das Feld slug heißt in der Oberfläche „Web-Adresse“ (cuedesk.de/…).
